...
public class CustomerSignUpCommand implements Command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		String cPw = mr.getParameter("cPw");
		String cName = mr.getParameter("cName");
		String cNickname = mr.getParameter("cNickname");
		String cPhone = mr.getParameter("cPhone");
		String cEmail = mr.getParameter("cEmail");
		String cGender = mr.getParameter("cGender");
		...
		try {
			...
			ldao.customerSignUp(cId, cPw, cName, cNickname, cPhone, cEmail, saveFilename, cGender);
		} catch (Exception e) {
			e.printStackTrace();
		} 
